...
(function () {
  ...
  function applyTheme(theme) {
    ...
    /* Browser-chrome kleur laten meeschakelen met het thema */
    var metaTheme = document.querySelector('meta[name="theme-color"]');
    if (metaTheme) {
      metaTheme.setAttribute("content", theme === "light" ? "#F8FAFF" : "#0A0A0F");
    }
    ...
    btns.forEach(function (b) {
      ...
      b.setAttribute("aria-label", theme === "light"
        ? (isEN ? "Switch to dark theme" : "Schakel naar donker thema")
        : (isEN ? "Switch to light theme" : "Schakel naar licht thema"));
    });
  }
